      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="md:w-1/2 text-left">
          ...
          <p className="text-gray-600 mb-6 text-sm md:text-base leading-relaxed">
            Taşınmak zahmetli olmak zorunda değil. Hem fiziksel hem de planlama açısından tüm yükünüzü üstleniyoruz. 
          ...
          <button className="bg-gradient-to-r from-blue-900 to-cyan-400 text-white px-6 py-2 rounded-md transition">
            Hemen Bizi Arayın
          </button>
        </div>
