        ...
        <Accordion type="single" collapsible className="w-full xl:w-[80%]">
            <AccordionItem value="item-1">
                <AccordionTrigger className="font-bold text-xl max-md:text-base">
                    <h3>  AKR Nakliyat ile taşınma süreci nasıl işler? </h3>
                </AccordionTrigger>
                <AccordionContent>
            ...
            <AccordionItem value="item-2">
                <AccordionTrigger className="font-bold text-xl max-md:text-base">
                  <h3>  Nakliye sırasında eşyalarımın zarar görmemesi için ne yapılıyor? </h3>
                </AccordionTrigger>
                <AccordionContent>
            ...
            <AccordionItem value="item-3">
                <AccordionTrigger className="font-bold text-xl max-md:text-base">
                    <h3>Nakliyat fiyatları nasıl belirleniyor? </h3>
                </AccordionTrigger>
                <AccordionContent>
            ...
            <AccordionItem value="item-4">
                <AccordionTrigger className="font-bold text-xl max-md:text-base">
                 <h3>   Hangi şehirlerde hizmet veriyorsunuz? </h3>
                </AccordionTrigger>
                <AccordionContent>
            ...
            <AccordionItem value="item-5">
                <AccordionTrigger className="font-bold text-xl max-md:text-base">
                  <h3>  Taşınma öncesi nelere dikkat etmeliyim? </h3>
                </AccordionTrigger>
                <AccordionContent>
